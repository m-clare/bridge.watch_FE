...
<${Typography} variant="body1" paragraph>
D3 visualizations are derived from the work of <${Link} href="https://observablehq.com/@mbostock" underline="hover"><b>Mike Bostock</b></${Link}> over on <${Link} href="https://observablehq.com/@d3/charts" underline="hover"><b>ObservableHQ</b></${Link}>.
</${Typography}>
<${Typography} variant="h4" component="h1" gutterBottom>Disclaimer</${Typography}>
<${Typography} variant="body1" gutterBottom>
This is a passion project, and Maryanne Wachter assumes no responsibility or liability for any errors or omissions in the content of this site. All information is provided on an "as is" basis with no guarantee of completeness, accuracy, usefulness, or of the results obtained from the use of this information.
</${Typography}>
</${Grid}>
</${Grid}>
</${Paper}>
