...
`;
  } else if ((summaryType === "average_daily_traffic" || summaryType === "truck_traffic") && locality === "the U.S.") {
    return html`
...
} else if ((summaryType === "average_daily_traffic" || summaryType === "truck_traffic")) {
  return html`
