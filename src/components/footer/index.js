...
export default function Footer() {
  ...
  return html`
<${Box} sx=${{ flexGrow: 1, padding: 2, boxShadow: 3, bgcolor: "primary.main", color: "primary.contrastText"}} >
  <${Container} maxWidth="lg">
    <${Grid} container sx=${{padding: 2}} spacing=${3}>
      ...
      <${Grid} item xs=${12} md=${4} sx=${{paddingTop: 1, }}>
